...
internal fun ReceiptValidationSection(
    ...
    Text(stringResource(R.string.activation_section_receipt_validation), style = MaterialTheme.typography.titleMedium)
    ...
    Row(
        ...
        OutlinedTextField(
            ...
            label = { Text(stringResource(R.string.activation_label_receipt_max_age)) },
        ...
        TextButton(
            ...
            Text(stringResource(R.string.activation_button_reset))
        }
    }
}
