...
internal fun RewardCurrencySection(
    ...
    Text(stringResource(R.string.activation_section_reward_currency), style = MaterialTheme.typography.titleMedium)
    Spacer(modifier = Modifier.height(8.dp))

    OutlinedTextField(
        value = currencyName,
        onValueChange = onCurrencyNameChange,
        label = { Text(stringResource(R.string.activation_label_currency_name)) },
        singleLine = true,
    ...
    OutlinedTextField(
        ...
        label = { Text(stringResource(R.string.activation_label_payout_percentage)) },
    ...
    Text(stringResource(R.string.activation_label_reward_icon), style = MaterialTheme.typography.bodyMedium)
    ...
    Row(
        ...
        iconBase64?.let { base64 ->
            runCatching {
                ...
                Image(
                    ...
                    contentDescription = stringResource(R.string.activation_label_reward_icon),
        ...
        OutlinedButton(onClick = { iconPickerLauncher.launch("image/*") }) {
            Text(stringResource(R.string.activation_action_pick_icon))
        }

        if (iconBase64 != null) {
            TextButton(onClick = { onIconBase64Change(null) }) {
                Text(stringResource(R.string.activation_action_clear_icon))
            }
        }
    }
}
