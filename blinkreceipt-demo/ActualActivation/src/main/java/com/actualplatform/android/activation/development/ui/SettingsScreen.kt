...
internal fun SettingsSummary(
    ...
    Column(modifier = modifier) {
        ...
        SettingsSummaryRow(
            stringResource(R.string.main_activations_editText_hint_email),
            settings.email.ifEmpty { "—" })
        SettingsSummaryRow(
            stringResource(R.string.main_activations_editText_hint_phone),
            settings.phone.ifEmpty { "—" })

        SectionHeader(stringResource(R.string.activations_section_environment))
        SettingsSummaryRow(
            stringResource(R.string.activations_section_environment),
            settings.environment
        )

        SectionHeader(stringResource(R.string.activations_section_test_options))
        SettingsSummaryRow(
            stringResource(R.string.activations_label_test_ads),
            if (settings.testAds) "On" else "Off"
        )
        SettingsSummaryRow(
            stringResource(R.string.activations_label_test_mode),
        ...
        if (settings.forcePlacements.isNotEmpty()) {
            ...
            SettingsSummaryRow(
                stringResource(R.string.activations_label_force_placements),
            ...
            TopAppBar(
                ...
                navigationIcon = {
                    IconButton(onClick = onBack) {
                        Icon(painterResource(R.drawable.ic_arrow_back), contentDescription = stringResource(R.string.activations_nav_back))
                    }
                },
            )
        },
...
private fun EditModeContent(
    ...
    val invalidEmailErrorLabel = stringResource(R.string.activations_error_invalid_email)
