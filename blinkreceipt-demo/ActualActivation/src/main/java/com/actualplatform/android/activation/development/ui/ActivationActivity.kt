...
internal class ActivationActivity : ComponentActivity() {
    ...
    companion object {
        ...
        internal const val PREFS_NAME = "activations_prefs"
        internal const val PREF_ENVIRONMENT = "activations_environment"
        internal const val PREF_TEST_ADS = "activations_test_ads"
        internal const val PREF_TEST_MODE = "activations_test_mode"
        internal const val PREF_EMAIL = "email_address"
        internal const val PREF_PHONE = "phone_number"
        internal const val PREF_FORCE_PLACEMENTS = "activations_force_placements"
        internal const val PREF_SCAN_REWARD = "activations_scan_reward"
        internal const val PREF_REWARD_CURRENCY_NAME = "activations_reward_currency_name"
        internal const val PREF_REWARD_PAYOUT_PERCENTAGE = "activations_reward_payout_percentage"
        internal const val PREF_REWARD_ICON_BASE64 = "activations_reward_icon_base64"
        internal const val PREF_SHOW_HEADER = "activations_show_header"
        internal const val PREF_RECEIPT_MAX_AGE_DAYS = "activations_receipt_max_age_days"
